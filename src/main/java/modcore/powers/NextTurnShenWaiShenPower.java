...
public class NextTurnShenWaiShenPower extends AbstractPower
{
    // 能力的ID
    public static final String POWER_ID = ("blackmythwukong:NextTurnShenWaiShenPower");
    // 能力的本地化字段
    ...
    public NextTurnShenWaiShenPower(AbstractCreature owner, int Amount)
    {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
