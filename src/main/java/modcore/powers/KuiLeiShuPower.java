...
public class KuiLeiShuPower extends AbstractPower
{
    // 能力的ID
    public static final String POWER_ID = ("blackmythwukong:KuiLeiShu");
    // 能力的本地化字段
    ...
    public KuiLeiShuPower(AbstractCreature owner)
    {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
