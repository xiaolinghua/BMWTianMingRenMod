...
public class BeiLiWanPower extends AbstractPower
{
    // 能力的ID
    public static final String POWER_ID = ("blackmythwukong:BeiLiWanPower");
    // 能力的本地化字段
    ...
    public BeiLiWanPower(AbstractCreature owner, int Amount)
    {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
