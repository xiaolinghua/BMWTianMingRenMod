...
public class HuaXianWeiYiPower extends AbstractPower
{
    // 能力的ID
    public static final String POWER_ID = ("blackmythwukong:HuaXianWeiYiPower");
    // 能力的本地化字段
    ...
    public HuaXianWeiYiPower(AbstractCreature owner, int Amount)
    {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    {
        if (power.ID.equals("blackmythwukong:GunShi") && target.isPlayer) {
           flash();
