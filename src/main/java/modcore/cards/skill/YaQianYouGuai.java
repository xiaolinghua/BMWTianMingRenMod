...
import modcore.monsters.ShuangShuang;
import modcore.utils.SfxUtil;

import static modcore.Characters.WuKong.Enums.BMW_CARD;

public class YaQianYouGuai extends AbstractB1Card {
    public static final String ID = "blackmythwukong:YaQianYouGuai";
    ...
    {
        sfxUtil.playSFX();
        ShuangShuang shuangShuang = new ShuangShuang(0, 0);
        addToBot(new SpawnFenShenAction(shuangShuang,null));
    }
